...
from moonlang.lang.choices import ChoicesSamplingMethod
...
class SglFunction:
    ...
    def run(
        ...
        **kwargs,
        ...
        from moonlang.lang.interpreter import run_program
    ...
    def run_batch(
        ...
        *,
        ...
        from moonlang.lang.interpreter import run_program_batch
    ...
    def trace(self, *, backend=None, **kwargs):
        from moonlang.lang.tracer import trace_program

        backend = backend or global_config.default_backend
        return trace_program(self, kwargs, backend)

    def cache(self, backend=None):
        from moonlang.lang.interpreter import cache_program

        backend = backend or global_config.default_backend
        return cache_program(self, backend)

    def __call__(self, *args, **kwargs):
        from moonlang.lang.tracer import TracingScope
