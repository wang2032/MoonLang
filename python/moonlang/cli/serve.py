...
from moonlang.cli.utils import get_is_diffusion_model, get_model_path
...
def serve(args, extra_argv):
    if any(h in extra_argv for h in ("-h", "--help")):
        ...
        from moonlang.multimodal_gen.runtime.entrypoints.cli.serve import (
    ...
    try:
        ...
        if is_diffusion_model:
            ...
            from moonlang.launch_server import run_server
            from moonlang.srt.server_args import prepare_server_args
