...
from moonlang.srt.debug_utils.comparator.tensor_comparator.formatter import (
    format_comparison,
)
from moonlang.srt.debug_utils.comparator.tensor_comparator.types import (
    TensorComparisonInfo,
)
from moonlang.srt.debug_utils.comparator.utils import _StrictBase
...
class _TableRecord(_OutputRecord):
    ...
    def _format_body(self) -> str:
        from moonlang.srt.debug_utils.comparator.display import _render_polars_as_text
