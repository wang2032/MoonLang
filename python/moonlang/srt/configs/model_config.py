...
from moonlang.srt.layers.quantization import QUANTIZATION_METHODS
from moonlang.srt.server_args import ServerArgs
from moonlang.srt.utils import is_hip, is_sm100_supported, retry
...
class ModelConfig:
    ...
    def _is_already_quantized(self) -> bool:
        ...
        from moonlang.srt.utils import has_hf_quant_config
    ...
    def _maybe_pull_model_tokenizer_from_remote(self) -> None:
        ...
        from moonlang.srt.utils import is_remote_url
