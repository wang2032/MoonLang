...
from moonlang.srt.eplb.expert_location_dispatch import topk_ids_logical_to_physical
from moonlang.srt.layers.moe.routed_experts_capturer import get_global_experts_capturer
from moonlang.srt.layers.moe.topk import StandardTopKOutput, select_experts

if TYPE_CHECKING:
    from moonlang.srt.eplb.expert_location_dispatch import ExpertLocationDispatchInfo
    from moonlang.srt.layers.moe.topk import TopKConfig, TopKOutput
