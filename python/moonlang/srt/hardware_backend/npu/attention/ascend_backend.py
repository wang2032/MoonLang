...
from moonlang.srt.hardware_backend.npu.attention.ascend_torch_native_backend import (
    AscendTorchNativeAttnBackend,
)
from moonlang.srt.hardware_backend.npu.attention.mla_preprocess import (
    is_fia_nz,
