...
from moonlang.srt.constrained.base_grammar_backend import (
    INVALID_GRAMMAR_OBJ,
    BaseGrammarBackend,
    BaseGrammarObject,
    GrammarStats,
)
from moonlang.srt.constrained.utils import is_legacy_structural_tag
...
if _is_hip:
    ...
    from moonlang.srt.constrained.triton_ops.bitmask_ops import (
...
def demo_test():
    ...
    from moonlang.test.test_utils import DEFAULT_MODEL_NAME_FOR_TEST
