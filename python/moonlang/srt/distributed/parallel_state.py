...
from moonlang.srt.compilation.compilation_config import register_split_op
...
class GroupCoordinator:
    ...
    def __init__(
        ...
        from moonlang.srt.distributed.device_communicators.custom_all_reduce import (
            dispatch_custom_allreduce,
        )
        from moonlang.srt.distributed.device_communicators.pymscclpp import (
            PyMscclppCommunicator,
        )
        from moonlang.srt.distributed.device_communicators.pynccl import (
            PyNcclCommunicator,
        )
        ...
        from moonlang.srt.distributed.device_communicators.torch_symm_mem import (
        ...
        if is_hip():
            from moonlang.srt.distributed.device_communicators.quick_all_reduce import (
                QuickAllReduce,
        ...
        from moonlang.srt.distributed.device_communicators.hpu_communicator import (
            HpuCommunicator,
        )
        from moonlang.srt.distributed.device_communicators.npu_communicator import (
            NpuCommunicator,
        )
        from moonlang.srt.distributed.device_communicators.xpu_communicator import (
            XpuCommunicator,
        )
        ...
        from moonlang.srt.distributed.device_communicators.shm_broadcast import (
            MessageQueue,
        )
...
def initialize_model_parallel(
    ...
    from moonlang.srt.layers.sampler import SYNC_TOKEN_IDS_ACROSS_TP
