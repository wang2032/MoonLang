...
def make_layers(
    ...
    # circula imports
    from moonlang.srt.distributed import get_pp_indices
...
def monkey_patch_p2p_access_check():
    ...
    import moonlang.srt.distributed.device_communicators.custom_all_reduce_utils as tgt
...
def point_to_point_pyobj(
    ...
    from moonlang.srt.distributed.parallel_state import P2PWork
...
class SafeUnpickler(pickle.Unpickler):
    ALLOWED_MODULE_PREFIXES = {
        ...
        "huggingface_hub.",
        # --- SGLang & Unitest ---
        "moonlang.srt.weight_sync.tensor_bucket.",
        "moonlang.srt.model_executor.model_runner.",
        "moonlang.srt.layers.",
        "moonlang.srt.utils.",
    }
...
def _configure_uvicorn_access_log_filter(
    ...
    uvicorn_logging_config["filters"][filter_name] = {
        "()": "moonlang.srt.utils.common.UvicornAccessLogFilter",
