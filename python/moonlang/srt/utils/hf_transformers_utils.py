...
from moonlang.srt.configs.internvl import InternVLChatConfig
from moonlang.srt.connector import create_remote_connector
from moonlang.srt.multimodal.customized_mm_processor_utils import _CUSTOMIZED_MM_PROCESSOR
from moonlang.srt.utils import is_remote_url, logger, lru_cache_frozenset, mistral_utils
from moonlang.srt.utils.patch_tokenizer import patch_tokenizer
...
def get_tokenizer(
    ...
    **kwargs,
    ...
    if tokenizer_name.endswith(".json"):
        from moonlang.srt.tokenizer.tiktoken_tokenizer import TiktokenTokenizer
