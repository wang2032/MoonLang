...
from moonlang.srt.configs.model_config import get_nsa_index_head_dim, is_deepseek_nsa
from moonlang.srt.distributed.parallel_state import get_world_group
from moonlang.srt.layers.dp_attention import get_attention_tp_size
from moonlang.srt.mem_cache.allocator import (
...
from moonlang.srt.mem_cache.swa_memory_pool import SWAKVPool, SWATokenToKVPoolAllocator
    ...
    def init_memory_pool(self: ModelRunner, total_gpu_memory: int):
        ...
        if self.token_to_kv_pool_allocator is None:
            if _is_npu and (
                ...
                from moonlang.srt.hardware_backend.npu.allocator_npu import (
