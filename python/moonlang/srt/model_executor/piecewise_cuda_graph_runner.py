...
from moonlang.srt.compilation.compilation_config import CompilationConfig
from moonlang.srt.compilation.compile import install_torch_compiled, set_compiled
...
from moonlang.srt.distributed.parallel_state import graph_capture
...
from moonlang.srt.utils import get_available_gpu_memory, is_npu, log_info_on_rank0
...
class PiecewiseCudaGraphRunner:
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        if get_moe_a2a_backend().is_deepep() or get_moe_a2a_backend().is_mooncake():
            self.compile_config.add_split_op(
                "moonlang.moe_forward_piecewise_cuda_graph_impl"
            )
    ...
    def get_spec_info(self, num_tokens: int):
        ...
        if (
            ...
            from moonlang.srt.speculative.eagle_utils import EagleVerifyInput
