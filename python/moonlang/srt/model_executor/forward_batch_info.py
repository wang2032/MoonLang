...
from moonlang.srt.layers.attention.nsa.utils import NSAContextParallelMetadata
...
from moonlang.srt.model_executor.forward_batch_deepseek_mha_mixin import (
    ForwardBatchDeepSeekMHAMixin,
)
from moonlang.srt.server_args import get_global_server_args
from moonlang.srt.utils import get_compiler_backend, is_hip, is_npu, support_triton
...
if TYPE_CHECKING:
    ...
    from moonlang.srt.managers.schedule_batch import ModelWorkerBatch, MultimodalInputs
    from moonlang.srt.mem_cache.memory_pool import KVCache, ReqToTokenPool
...
class ForwardBatch(ForwardBatchDeepSeekMHAMixin):
    ...
    def adjust_num_token_non_padded_for_attn_tp(self, server_args) -> None:
        ...
        from moonlang.srt.utils.common import require_mlp_tp_gather
    ...
    def prepare_mlp_sync_batch(self, model_runner: ModelRunner):
        from moonlang.srt.batch_overlap.two_batch_overlap import TboForwardBatchPreparer
    ...
    def prepare_attn_tp_scatter_input(self, model_runner: ModelRunner):
        from moonlang.srt.layers.communicator import get_attn_tp_context
