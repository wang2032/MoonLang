...
from moonlang.jit_kernel.kvcache import can_use_store_cache, store_cache
from moonlang.srt.configs.mamba_utils import BaseLinearStateParams
from moonlang.srt.constants import GPU_MEMORY_TYPE_KV_CACHE
from moonlang.srt.environ import envs
from moonlang.srt.layers.attention.nsa import index_buf_accessor
from moonlang.srt.layers.attention.nsa.quant_k_cache import (
    quantize_k_cache,
    quantize_k_cache_separate,
)
from moonlang.srt.layers.radix_attention import RadixAttention
from moonlang.srt.mem_cache.utils import (
...
if TYPE_CHECKING:
    from moonlang.srt.managers.cache_controller import LayerDoneCounter
        ...
        *,
        ...
        with self.memory_saver_adapter.region(GPU_MEMORY_TYPE_KV_CACHE), (
            ...
            if _is_cpu and _cpu_has_amx_support:
                from moonlang.srt.layers.amx_utils import _init_amx_conv_state
...
class MHATokenToKVPoolFP4(MHATokenToKVPool):
    ...
    def _get_key_buffer(self, layer_id: int):
        ...
        if self.store_dtype != self.dtype:
            ...
            from moonlang.srt.layers.quantization.kvfp4_tensor import KVFP4QuantizeUtil
...
class HybridLinearKVPool(KVCache):
    ...
    def __init__(
        ...
        if not use_mla:
            ...
            if _is_npu:
                from moonlang.srt.hardware_backend.npu.memory_pool_npu import (
                    NPUMHATokenToKVPool,
                )
...
class MLATokenToKVPoolFP4(MLATokenToKVPool):
    ...
    def set_mla_kv_buffer(
        ...
        if self.nsa_kv_cache_store_fp8:
            ...
            if cache_k_nope.dtype != self.dtype:
                from moonlang.srt.layers.quantization.kvfp4_tensor import (
                    KVFP4QuantizeUtil,
                )
