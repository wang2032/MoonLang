...
from moonlang.jit_kernel.hicache import (
...
from moonlang.srt.utils import is_cuda, is_npu, is_xpu
...
def get_allocator_from_storage(allocator_type):
    if allocator_type == "mooncake":
        try:
            from moonlang.srt.mem_cache.storage.mooncake_store.mooncake_store import (
