...
from moonlang.srt.layers.activation import GeluAndMul
from moonlang.srt.layers.elementwise import (
...
from moonlang.srt.layers.moe.router import fused_moe_router_shim
...
from moonlang.srt.layers.rotary_embedding import (
    RotaryEmbedding,
...
from moonlang.srt.model_loader.loader import DefaultModelLoader
from moonlang.srt.model_loader.weight_utils import default_weight_loader
from moonlang.srt.utils import add_prefix
...
def _prepare_presharded_weights(
    ...
    if not os.path.isdir(model_name_or_path):
        from moonlang.srt.model_loader.weight_utils import download_weights_from_hf
