...
from moonlang.srt.configs.mamba_utils import Mamba2CacheParams
from moonlang.srt.constants import GPU_MEMORY_TYPE_KV_CACHE
from moonlang.srt.disaggregation.base import KVPoll
from moonlang.srt.disaggregation.common.conn import CommonKVManager, CommonKVReceiver
...
from moonlang.srt.managers.schedule_batch import FINISH_ABORT, ScheduleBatch
from moonlang.srt.managers.utils import GenerationBatchResult
from moonlang.srt.mem_cache.allocator import BaseTokenToKVPoolAllocator
from moonlang.srt.mem_cache.base_prefix_cache import BasePrefixCache
from moonlang.srt.mem_cache.common import release_kv_cache
from moonlang.srt.mem_cache.memory_pool import (
    HybridLinearKVPool,
...
from moonlang.srt.mem_cache.swa_memory_pool import SWAKVPool
from moonlang.srt.observability.req_time_stats import (
    set_schedule_time_batch,
    set_time_batch,
)
from moonlang.srt.utils import get_int_env_var
from moonlang.srt.utils.torch_memory_saver_adapter import TorchMemorySaverAdapter

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from moonlang.srt.managers.schedule_batch import Req
    from moonlang.srt.managers.scheduler import Scheduler
...
class DecodePreallocQueue:
    ...
    def _resolve_pending_reqs(self) -> None:
        ...
        if need_query:
            from moonlang.srt.disaggregation.common.conn import CommonKVReceiver
