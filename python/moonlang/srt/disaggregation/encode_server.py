...
from moonlang.srt.disaggregation.encode_receiver import EmbeddingData
...
from moonlang.srt.layers.dp_attention import initialize_dp_attention
from moonlang.srt.managers.io_struct import ProfileReq, ProfileReqInput, ProfileReqType
from moonlang.srt.managers.schedule_batch import Modality, MultimodalDataItem
from moonlang.srt.mem_cache.multimodal_cache import EmbeddingResult, MultiModalStaticCache
from moonlang.srt.model_loader import get_model
...
class MMEncoder:
    def __init__(
        ...
        if self.server_args.enable_mm_global_cache:
            from moonlang.srt.mem_cache.storage.mooncake_store.embedding_cache_controller import (
