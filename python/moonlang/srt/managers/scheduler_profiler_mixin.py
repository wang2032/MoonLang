...
from moonlang.srt.managers.io_struct import ProfileReq, ProfileReqOutput, ProfileReqType
...
from moonlang.srt.utils.profile_merger import ProfileMerger
from moonlang.srt.utils.profile_utils import ProfileManager
...
class SchedulerProfilerMixin:
    ...
    def stop_profile(
        ...
        if self.rpd_profiler is not None:
            ...
            torch.distributed.barrier(self.dp_tp_cpu_group)
            if self.tp_rank == 0:
                from moonlang.srt.utils.rpd_utils import rpd_to_chrome_trace
