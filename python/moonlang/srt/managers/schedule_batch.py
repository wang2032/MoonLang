...
from moonlang.srt.dllm.config import DllmConfig
from moonlang.srt.model_executor.forward_batch_info import ForwardBatch
from moonlang.srt.utils.common import ceil_align
...
from moonlang.srt.constrained.base_grammar_backend import BaseGrammarObject
from moonlang.srt.disaggregation.base import BaseKVSender
from moonlang.srt.disaggregation.decode_schedule_batch_mixin import (
    ScheduleBatchDisaggregationDecodeMixin,
)
from moonlang.srt.disaggregation.utils import DisaggregationMode
from moonlang.srt.distributed.parallel_state import get_tensor_model_parallel_rank
from moonlang.srt.dllm.mixin.req import ReqDllmMixin
from moonlang.srt.environ import envs
from moonlang.srt.layers.attention.fla.chunk_delta_h import CHUNK_SIZE as FLA_CHUNK_SIZE
from moonlang.srt.mem_cache.allocator import BaseTokenToKVPoolAllocator
from moonlang.srt.mem_cache.base_prefix_cache import BasePrefixCache, MatchPrefixParams
from moonlang.srt.mem_cache.common import (
    alloc_for_decode,
    alloc_for_extend,
...
from moonlang.srt.mem_cache.radix_cache import RadixKey
from moonlang.srt.mem_cache.swa_memory_pool import SWATokenToKVPoolAllocator
from moonlang.srt.model_executor.forward_batch_info import (
    CaptureHiddenMode,
    ForwardBatch,
    ForwardMode,
)
from moonlang.srt.observability.metrics_collector import (
    DPCooperationInfo,
...
from moonlang.srt.server_args import ServerArgs, get_global_server_args
from moonlang.srt.utils import flatten_nested_list
from moonlang.srt.utils.cuda_ipc_transport_utils import CudaIpcTensorTransportProxy

if TYPE_CHECKING:
    from typing import Any, Dict

    from moonlang.srt.configs.model_config import ModelConfig
    from moonlang.srt.observability.scheduler_metrics_mixin import PrefillStats
    from moonlang.srt.speculative.eagle_info import EagleDraftInput
    from moonlang.srt.speculative.spec_info import SpecInput, SpeculativeAlgorithm
...
class MultimodalDataItem:
    ...
    def set_pad_value(self):
        ...
        from moonlang.srt.managers.mm_utils import hash_feature
...
class MultimodalInputs:
    ...
    def from_dict(obj: dict):
        ...
        if not envs.SGLANG_ENABLE_MM_SPLITTING.get():
            ...
            from moonlang.srt.managers.mm_utils import get_new_expanded_mm_items
        ...
        if envs.SGLANG_MM_BUFFER_SIZE_MB.get() > 0:
            ...
            from moonlang.srt.managers.mm_utils import (
                init_feature_buffer,
