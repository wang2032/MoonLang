...
from moonlang.srt.layers.multimodal import gpu_tensor_hash
...
from moonlang.srt.multimodal.evs import EVSEmbeddingResult
from moonlang.srt.server_args import get_global_server_args
from moonlang.srt.utils import flatten_nested_list, is_npu, print_warning_once
from moonlang.utils import logger

_is_npu = is_npu()

# NOTE: Using the shared logger from moonlang.utils instead of creating a module-specific logger
...
def _get_is_default_transport():
    ...
    if _is_default_tensor_transport is None:
        from moonlang.srt.managers.tokenizer_manager import (
