...
from moonlang.srt.disaggregation.utils import FAKE_BOOTSTRAP_HOST, DisaggregationMode
from moonlang.srt.entrypoints.anthropic.protocol import (
    AnthropicCountTokensRequest,
    AnthropicMessagesRequest,
)
from moonlang.srt.entrypoints.anthropic.serving import AnthropicServing
from moonlang.srt.entrypoints.engine import (
    _launch_subprocesses,
    init_tokenizer_manager,
    run_detokenizer_process,
    run_scheduler_process,
)
from moonlang.srt.entrypoints.ollama.protocol import (
    OllamaChatRequest,
    OllamaGenerateRequest,
    OllamaShowRequest,
)
from moonlang.srt.entrypoints.ollama.serving import OllamaServing
from moonlang.srt.entrypoints.openai.protocol import (
...
from moonlang.srt.entrypoints.openai.serving_chat import OpenAIServingChat
from moonlang.srt.entrypoints.openai.serving_classify import OpenAIServingClassify
from moonlang.srt.entrypoints.openai.serving_completions import OpenAIServingCompletion
from moonlang.srt.entrypoints.openai.serving_embedding import OpenAIServingEmbedding
from moonlang.srt.entrypoints.openai.serving_rerank import OpenAIServingRerank
from moonlang.srt.entrypoints.openai.serving_score import OpenAIServingScore
from moonlang.srt.entrypoints.openai.serving_tokenize import (
    OpenAIServingDetokenize,
    OpenAIServingTokenize,
)
from moonlang.srt.entrypoints.openai.serving_transcription import (
    OpenAIServingTranscription,
)
from moonlang.srt.entrypoints.warmup import execute_warmups
from moonlang.srt.environ import envs
from moonlang.srt.function_call.function_call_parser import FunctionCallParser
...
from moonlang.srt.managers.multi_tokenizer_mixin import (
...
from moonlang.srt.managers.template_manager import TemplateManager
from moonlang.srt.managers.tokenizer_manager import ServerStatus, TokenizerManager
from moonlang.srt.model_loader.remote_instance_weight_loader_utils import (
    parse_remote_instance_transfer_engine_info_from_scheduler_infos,
)
from moonlang.srt.observability.func_timer import enable_func_timer
from moonlang.srt.observability.trace import (
    process_tracing_init,
    set_global_trace_level,
    trace_set_thread_info,
)
from moonlang.srt.parser.reasoning_parser import ReasoningParser
from moonlang.srt.server_args import PortArgs, ServerArgs
...
from moonlang.srt.utils.auth import AuthLevel, app_has_admin_force_endpoints, auth_level
from moonlang.utils import get_exception_traceback
...
async def lifespan(fast_api_app: FastAPI):
    ...
    if server_args.tool_server == "demo":
        from moonlang.srt.entrypoints.openai.tool_server import DemoToolServer

        tool_server = DemoToolServer()
    elif server_args.tool_server:
        from moonlang.srt.entrypoints.openai.tool_server import MCPToolServer

        tool_server = MCPToolServer()
        await tool_server.add_tool_server(server_args.tool_server)

    try:
        from moonlang.srt.entrypoints.openai.serving_responses import (
...
# Include routers
from moonlang.srt.entrypoints.v1_loads import router as v1_loads_router
...
def launch_server(
    ...
    if server_args.tokenizer_worker_num == 1:
        ...
        if (
            ...
            from moonlang.srt.utils.auth import add_api_key_middleware
    ...
    try:
        ...
        if server_args.tokenizer_worker_num == 1:
            ...
            LOGGING_CONFIG["loggers"]["moonlang.srt.entrypoints.http_server"] = {
                "handlers": ["default"],
                "level": "INFO",
                "propagate": False,
            }
            ...
            uvicorn.run(
                "moonlang.srt.entrypoints.http_server:app",
                host=server_args.host,
                port=server_args.port,
                root_path=server_args.fastapi_root_path,
                log_level=server_args.log_level_http or server_args.log_level,
