...
from moonlang.srt.utils import print_info_once, print_warning_once

if TYPE_CHECKING:
    # Avoid circular import.
    from moonlang.srt.entrypoints.context import ConversationContext
...
class HarmonyBrowserTool(Tool):
    ...
    async def get_result(self, context: "ConversationContext") -> Any:
        from moonlang.srt.entrypoints.context import HarmonyContext
