...
from moonlang.srt.utils import get_bool_env_var, get_device_core_count
...
class WaveAttnBackend(AttentionBackend):
    def __init__(
        ...
        from moonlang.srt.layers.attention.wave_ops.decode_attention import (
            decode_attention_fwd,
        )
        from moonlang.srt.layers.attention.wave_ops.extend_attention import (
