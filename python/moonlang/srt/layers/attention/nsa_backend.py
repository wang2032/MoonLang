...
from moonlang.srt.configs.model_config import get_nsa_index_topk, is_deepseek_nsa
from moonlang.srt.environ import envs
from moonlang.srt.layers.attention.base_attn_backend import AttentionBackend
from moonlang.srt.layers.attention.nsa.dequant_k_cache import dequantize_k_cache_paged
from moonlang.srt.layers.attention.nsa.nsa_backend_mtp_precompute import (
    NativeSparseAttnBackendMTPPrecomputeMixin,
    PrecomputedMetadata,
    compute_cu_seqlens,
)
from moonlang.srt.layers.attention.nsa.nsa_indexer import BaseIndexerMetadata
from moonlang.srt.layers.attention.nsa.nsa_mtp_verification import (
    verify_multi_backend_fused_metadata_copy,
    verify_single_backend_fused_metadata_copy,
)
from moonlang.srt.layers.attention.nsa.quant_k_cache import quantize_k_cache
from moonlang.srt.layers.attention.nsa.transform_index import (
...
from moonlang.srt.layers.attention.utils import (
    concat_mla_absorb_q_general,
    mla_quantize_and_rope_for_fp8,
)
from moonlang.srt.layers.dp_attention import get_attention_tp_size
from moonlang.srt.model_executor.forward_batch_info import ForwardBatch, ForwardMode
from moonlang.srt.utils import is_cuda, is_hip
...
if TYPE_CHECKING:
    ...
    from moonlang.srt.speculative.spec_info import SpecInput
...
class NativeSparseAttnBackend(
    ...
    def init_forward_metadata_replay_cuda_graph_from_precomputed(
        ...
        if _USE_FUSED_METADATA_COPY:
            try:
                from moonlang.jit_kernel.fused_metadata_copy import (
    ...
    def _forward_tilelang(
        ...
        from moonlang.srt.layers.attention.nsa.tilelang_kernel import tilelang_sparse_fwd
    ...
    def set_nsa_prefill_impl(self, forward_batch: Optional[ForwardBatch] = None):
        ...
        """
        from moonlang.srt.utils import get_device_sm, is_blackwell
