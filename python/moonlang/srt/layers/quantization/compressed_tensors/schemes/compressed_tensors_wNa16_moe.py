...
from moonlang.srt.layers.quantization.gptq import gptq_marlin_moe_repack
from moonlang.srt.layers.quantization.marlin_utils import marlin_moe_permute_scales
from moonlang.srt.layers.quantization.utils import replace_parameter
from moonlang.srt.utils import get_bool_env_var, is_cuda, is_hip, set_weight_attrs
...
class CompressedTensorsWNA16MoE(CompressedTensorsMoEScheme):
    ...
    def apply_weights(
        ...
        from moonlang.srt.layers.moe.fused_moe_triton.fused_marlin_moe import (
            fused_marlin_moe,
        )
