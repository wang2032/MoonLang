...
from moonlang.srt.layers.quantization.fp8_kernel import sglang_per_token_group_quant_fp8
from moonlang.srt.layers.quantization.mxfp4_tensor import MXFP4QuantizeUtil
from moonlang.srt.utils.common import torch_release
...
def _inverse_transform_scale_ue8m0_impl(sf_packed):
    ...
    if not torch.all(sf_unrepeated == sf_reshaped):
        from moonlang.srt.debug_utils.dumper import get_tensor_info
