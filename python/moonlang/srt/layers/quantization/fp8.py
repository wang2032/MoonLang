...
from moonlang.srt.distributed import get_tensor_model_parallel_world_size, get_tp_group
from moonlang.srt.distributed.device_communicators.pynccl_allocator import (
    use_symmetric_memory,
)
from moonlang.srt.environ import envs
from moonlang.srt.layers.amx_utils import (
    CPUQuantMethod,
    _amx_process_weight_after_loading,
)
from moonlang.srt.layers.dp_attention import is_allocation_symmetric
from moonlang.srt.layers.moe import MoeRunner, MoeRunnerBackend, MoeRunnerConfig
from moonlang.srt.layers.moe.moe_runner.deep_gemm import DeepGemmMoeQuantInfo
...
from moonlang.srt.layers.moe.utils import RoutingMethodType, get_moe_runner_backend
from moonlang.srt.layers.parameter import (
...
from moonlang.srt.layers.quantization.marlin_utils_fp8 import (
...
if TYPE_CHECKING:
    from moonlang.srt.layers.moe.token_dispatcher import CombineInput, DispatchOutput
    from moonlang.srt.layers.moe.topk import TopKOutput
    from moonlang.srt.layers.quantization.w4afp8 import W4AFp8Config
...
class Fp8LinearMethod(LinearMethodBase):
    ...
    def process_weights_after_loading_block_quant(self, layer: Module) -> None:
        ...
        if _is_fp8_fnuz:
            ...
            from moonlang.srt.model_loader.utils import (
...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def process_weights_after_loading_block_quant(self, layer: Module) -> None:
        ...
        if _is_fp8_fnuz:
            ...
            from moonlang.srt.layers.moe.ep_moe.layer import DeepEPMoE
            from moonlang.srt.model_loader.utils import (
                should_deepgemm_weight_requant_ue8m0,
            )
    ...
    def process_weights_hip_scale_padding(self, layer: Module):
        from moonlang.srt.layers.moe.fused_moe_triton.fused_moe import (
    ...
    def apply(
        ...
        if use_intel_amx_backend(layer):
            from moonlang.srt.layers.moe.topk import apply_topk_weights_cpu
        ...
        if get_moe_runner_backend().is_cutlass():
            from moonlang.srt.layers.moe.cutlass_moe import cutlass_fused_experts_fp8
