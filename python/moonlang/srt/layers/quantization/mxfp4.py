...
from moonlang.srt.layers.moe.utils import get_moe_runner_backend
from moonlang.srt.layers.quantization.base_config import (
    FusedMoEMethodBase,
    QuantizationConfig,
    QuantizeMethodBase,
)
from moonlang.srt.layers.quantization.utils import is_layer_skipped
...
from moonlang.srt.utils.common import get_bool_env_var
...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def apply(
        ...
        if backend.is_triton_kernels():
            from moonlang.srt.layers.moe.moe_runner.triton_kernels import (
