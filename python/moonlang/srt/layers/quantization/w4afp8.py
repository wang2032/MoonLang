...
from moonlang.srt.layers.quantization.fp8 import Fp8LinearMethod
...
from moonlang.srt.utils import set_weight_attrs

if TYPE_CHECKING:
    from moonlang.srt.layers.moe import MoeRunnerConfig
...
class W4AFp8MoEMethod(FusedMoEMethodBase):
    ...
    def apply(
        ...
        from moonlang.srt.layers.moe.cutlass_w4a8_moe import cutlass_w4a8_moe
    ...
    def apply_deepep_ll(
        ...
        from moonlang.srt.layers.moe.cutlass_w4a8_moe import cutlass_w4a8_moe_deepep_ll
    ...
    def apply_deepep_normal(
        ...
        from moonlang.srt.layers.moe.cutlass_w4a8_moe import (
