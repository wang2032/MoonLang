...
from moonlang.srt.utils import is_cuda, is_npu, set_weight_attrs
...
if _is_cuda:
    ...
    from moonlang.jit_kernel.gptq_marlin_repack import gptq_marlin_repack
...
class GPTQMarlinMoEMethod(FusedMoEMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        # Delay the import to avoid circular dependency
        from moonlang.srt.layers.linear import set_weight_attrs
