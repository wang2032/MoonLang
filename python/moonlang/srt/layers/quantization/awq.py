...
from moonlang.srt.hardware_backend.npu.quantization.fused_moe_method_npu import (
    npu_fused_experts,
)
from moonlang.srt.layers.linear import LinearBase, set_weight_attrs
...
from moonlang.srt.layers.moe.moe_runner.marlin import MarlinMoeQuantInfo
from moonlang.srt.layers.parameter import GroupQuantScaleParameter, PackedvLLMParameter
...
from moonlang.srt.layers.quantization.marlin_utils import (
...
from moonlang.srt.layers.quantization.utils import get_scalar_types, replace_parameter
...
from moonlang.srt.utils import is_cuda, is_hip, is_npu, is_xpu
...
if _is_cuda:
    from moonlang.jit_kernel.awq_dequantize import awq_dequantize
    from moonlang.jit_kernel.awq_marlin_repack import (
