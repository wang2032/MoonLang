...
from moonlang.srt.layers.parameter import BlockQuantScaleParameter, ModelWeightParameter
...
from moonlang.srt.layers.quantization.int8_utils import apply_w8a8_block_int8_linear
