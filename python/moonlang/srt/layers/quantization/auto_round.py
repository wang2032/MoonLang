...
from moonlang.srt.layers.quantization.utils import get_scalar_types
...
class AutoRoundConfig(QuantizationConfig):
    ...
    def apply_awq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if backend == "auto" or "marlin" in backend:
            ...
            use_marlin = False
        if use_marlin:
            from moonlang.srt.layers.quantization.awq import (
                AWQMarlinConfig,
            ...
            from moonlang.srt.layers.quantization.awq import AWQConfig, AWQLinearMethod
    ...
    def apply_gptq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if backend == "auto" or "marlin" in backend:
            ...
            use_marlin = False
        if use_marlin:
            from moonlang.srt.layers.quantization.gptq import (
                GPTQMarlinConfig,
            ...
            from moonlang.srt.layers.quantization.gptq import GPTQConfig, GPTQLinearMethod
