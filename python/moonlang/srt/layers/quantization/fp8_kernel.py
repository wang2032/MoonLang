...
if _is_cuda:
    ...
    from moonlang.jit_kernel.per_tensor_quant_fp8 import (
    ...
    from moonlang.jit_kernel.per_token_group_quant_8bit import (
...
def _per_token_group_quant_8bit_fuse_silu_and_mul(
    ...
    from moonlang.srt.layers.moe.ep_moe.kernels import silu_and_mul_masked_post_quant_fwd
...
def sglang_per_token_group_quant_8bit(
    ...
    from moonlang.srt.layers.quantization.int8_kernel import (
