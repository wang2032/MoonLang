...
from moonlang.srt.distributed import get_tp_group
from moonlang.srt.distributed.device_communicators.pynccl_allocator import (
    use_symmetric_memory,
)
from moonlang.srt.environ import envs
from moonlang.srt.layers.dp_attention import is_allocation_symmetric
...
from moonlang.srt.layers.moe.cutlass_moe_params import CutlassMoEParams, CutlassMoEType
from moonlang.srt.layers.moe.moe_runner.triton import TritonMoeQuantInfo
from moonlang.srt.layers.moe.utils import should_use_flashinfer_cutlass_moe_fp4_allgather
from moonlang.srt.layers.parameter import ModelWeightParameter, PerTensorScaleParameter
from moonlang.srt.layers.quantization.base_config import (
    FusedMoEMethodBase,
    LinearMethodBase,
    QuantizationConfig,
    QuantizeMethodBase,
)
from moonlang.srt.layers.quantization.fp4_utils import get_fp4_gemm_runner_backend
from moonlang.srt.layers.quantization.fp8_kernel import scaled_fp8_quant
from moonlang.srt.layers.quantization.fp8_utils import (
    apply_fp8_linear,
    cutlass_fp8_supported,
    is_blackwell_supported,
)
from moonlang.srt.layers.quantization.kv_cache import BaseKVCacheMethod
from moonlang.srt.layers.quantization.unquant import UnquantizedLinearMethod
from moonlang.srt.layers.quantization.utils import (
...
from moonlang.srt.utils.common import (
    get_bool_env_var,
    is_cuda,
    is_sm120_supported,
    next_power_of_2,
)
from moonlang.srt.utils.custom_op import register_custom_op
from moonlang.srt.utils.patch_torch import register_fake_if_exists

if TYPE_CHECKING:
    from moonlang.srt.batch_overlap.single_batch_overlap import DownGemmOverlapArgs
    from moonlang.srt.layers.moe.fused_moe_triton.layer import FusedMoE
    from moonlang.srt.layers.moe.token_dispatcher import (
        CombineInput,
        StandardDispatchOutput,
    )
    from moonlang.srt.models.utils import WeightsMapper
...
class ModelOptQuantConfig(QuantizationConfig):
    ...
    def _get_quant_method(
        ...
        *,
        ...
        from moonlang.srt.layers.linear import LinearBase
        from moonlang.srt.layers.moe.fused_moe_triton import FusedMoE
...
class ModelOptFp8MoEMethod(FusedMoEMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        from moonlang.srt.layers.moe.fused_moe_triton import FusedMoeWeightScaleSupported
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if get_moe_runner_backend().is_flashinfer_trtllm():
            from moonlang.srt.layers.moe.moe_runner.flashinfer_trtllm import (
    ...
    def apply(
        ...
        from moonlang.srt.layers.moe.topk import TopKOutputChecker
        ...
        if (
            ...
            from moonlang.srt.layers.moe.utils import RoutingMethodType
        ...
        if get_moe_runner_backend().is_flashinfer_cutlass():
            ...
            from moonlang.srt.layers.moe.token_dispatcher import StandardCombineInput
...
class ModelOptNvFp4FusedMoEMethod(FusedMoEMethodBase):
    ...
    def enable_flashinfer_cutlass_moe(self) -> bool:
        from moonlang.srt.layers.moe import get_moe_runner_backend
    ...
    def apply(
        ...
        if self.enable_flashinfer_cutlass_moe:
            from moonlang.srt.layers.moe.token_dispatcher import DispatchOutputChecker
        ...
        from moonlang.srt.layers.moe.cutlass_moe import cutlass_moe_fp4
    ...
    def apply_without_routing_weights(
        ...
        from moonlang.srt.layers.moe.flashinfer_cutedsl_moe import (
