...
from moonlang.srt.hardware_backend.npu.quantization.linear_method_npu import (
...
from moonlang.srt.layers.quantization.modelslim.schemes import (
    ModelSlimW4A4Int4,
...
from moonlang.srt.utils import apply_module_patch
...
if TYPE_CHECKING:
    ...
    from moonlang.srt.layers.quantization.base_config import QuantizeMethodBase
    from moonlang.srt.layers.quantization.modelslim.schemes import (
    ...
    def __init__(self, quant_config: Dict[str, Any] = {}):
        ...
        for name in self.quant_description.keys():
            if "norm.bias" in name:
                apply_module_patch(
                    "moonlang.srt.layers.layernorm.RMSNorm",
                    "__init__",
