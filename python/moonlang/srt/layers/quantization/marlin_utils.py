...
from moonlang.srt.utils import get_device_capability, is_cuda
...
from moonlang.srt.compilation.piecewise_context_manager import get_forward_context
...
if _is_cuda:
    from moonlang.jit_kernel.gptq_marlin import gptq_marlin_gemm
