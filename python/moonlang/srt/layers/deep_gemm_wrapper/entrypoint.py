...
from moonlang.srt.layers.deep_gemm_wrapper import compile_utils
from moonlang.srt.layers.deep_gemm_wrapper.configurer import (  # noqa: F401
    DEEPGEMM_BLACKWELL,
...
def _sanity_check_input(x_fp8: Tuple[torch.Tensor, torch.Tensor]):
    ...
    from moonlang.srt.layers.quantization.fp8_utils import ceil_to_ue8m0
