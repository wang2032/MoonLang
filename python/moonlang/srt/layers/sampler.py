...
from moonlang.srt.layers.utils.hash import murmur_hash32
from moonlang.srt.layers.utils.logprob import get_token_ids_logprobs, get_top_logprobs
from moonlang.srt.sampling.sampling_batch_info import SamplingBatchInfo
from moonlang.srt.sampling.sampling_params import TOP_K_ALL
from moonlang.srt.server_args import get_global_server_args
from moonlang.srt.utils.common import crash_on_warnings, get_bool_env_var, is_cuda, is_npu
...
def register_sampler_backend(backend: str, factory: Callable[[], "Sampler"]) -> None:
    ...
    from moonlang.srt.server_args import SAMPLING_BACKEND_CHOICES
