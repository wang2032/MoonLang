...
from moonlang.srt.utils import cpu_has_amx_support, is_cpu, is_cuda, is_hip, is_xpu
...
def fused_experts_none_to_triton(
    ...
    from moonlang.srt.layers.moe.fused_moe_triton.fused_moe import fused_experts
