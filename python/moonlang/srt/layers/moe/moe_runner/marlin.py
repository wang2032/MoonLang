...
def fused_experts_none_to_marlin(
    ...
    from moonlang.srt.layers.moe.fused_moe_triton.fused_marlin_moe import fused_marlin_moe
    from moonlang.srt.layers.moe.token_dispatcher.standard import StandardCombineInput
    from moonlang.srt.layers.quantization.marlin_utils import marlin_make_workspace
