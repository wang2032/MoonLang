...
from moonlang.srt.batch_overlap.two_batch_overlap import MaybeTboDeepEPDispatcher
...
from moonlang.srt.eplb.expert_location import get_global_expert_location_metadata
...
from moonlang.srt.layers.moe.kt_ep_wrapper import (
    KTEPWrapperMethod,
    create_kt_config_from_server_args,
)
from moonlang.srt.layers.moe.token_dispatcher import CombineInput, DispatchOutput
from moonlang.srt.layers.moe.token_dispatcher.base import BaseDispatcher
from moonlang.srt.layers.moe.token_dispatcher.flashinfer import FlashinferDispatcher
from moonlang.srt.layers.moe.token_dispatcher.standard import (
    StandardDispatcher,
)
from moonlang.srt.layers.moe.topk import (
    BypassedTopKOutput,
    StandardTopKOutput,
    TopKConfig,
    TopKOutput,
...
from moonlang.srt.layers.quantization.compressed_tensors.schemes import (
    CompressedTensorsMxInt4MoE,
)
from moonlang.srt.layers.quantization.fp8 import Fp8MoEMethod
from moonlang.srt.layers.quantization.modelopt_quant import ModelOptNvFp4FusedMoEMethod
from moonlang.srt.layers.quantization.unquant import UnquantizedFusedMoEMethod
from moonlang.srt.model_loader.weight_utils import narrow_padded_param_and_loaded_weight
...
def create_moe_dispatcher(moe_runner_config: MoeRunnerConfig) -> BaseDispatcher:
    ...
    if a2a_backend.is_none():
        ...
        from moonlang.srt.layers.moe.token_dispatcher import NpuFuseEPDispatcher
