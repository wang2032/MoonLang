...
from moonlang.srt.hardware_backend.npu.utils import npu_format_cast
...
from moonlang.srt.layers.moe.fused_moe_triton.layer import (
    FusedMoE,
    moe_forward_piecewise_cuda_graph_impl,
)
from moonlang.srt.layers.moe.rocm_moe_utils import upscale
...
from moonlang.srt.layers.moe.topk import TopKOutput, TopKOutputChecker
...
from moonlang.srt.layers.quantization.fp8 import Fp8Config, Fp8MoEMethod
from moonlang.srt.layers.quantization.fp8_kernel import is_fp8_fnuz
from moonlang.srt.layers.quantization.quark.schemes import QuarkW4A4MXFp4MoE
from moonlang.srt.layers.quantization.w4afp8 import W4AFp8Config, W4AFp8MoEMethod
from moonlang.srt.utils import get_bool_env_var, is_hip, is_npu
...
def get_moe_impl_class(quant_config: Optional[QuantizationConfig]):
    ...
    if get_moe_runner_backend().is_flashinfer_trtllm():
        ...
        if quant_config is not None and quant_config.get_name() == "modelopt_fp4":
            from moonlang.srt.layers.moe.fused_moe_triton.layer import FlashInferFP4MoE
