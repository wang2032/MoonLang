...
from moonlang.srt.eplb import expert_location_dispatch
from moonlang.srt.eplb.expert_distribution import get_global_expert_distribution_recorder
from moonlang.srt.eplb.expert_location_dispatch import (
...
from moonlang.srt.layers.moe.routed_experts_capturer import get_global_experts_capturer
...
class TopK(MultiPlatformOp):
    ...
    def forward_npu(
        ...
        *,
        ...
        from moonlang.srt.hardware_backend.npu.moe.topk import fused_topk_npu
...
def _post_process_topk_ids(
    ...
    if num_fused_shared_experts > 0 and _use_aiter:
        ...
        from moonlang.srt.layers.moe.fused_moe_triton.fused_moe_triton_kernels import (
