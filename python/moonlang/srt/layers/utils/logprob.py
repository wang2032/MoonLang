...
if TYPE_CHECKING:
    from moonlang.srt.layers.logits_processor import LogitsMetadata, LogitsProcessorOutput
    from moonlang.srt.managers.schedule_batch import ScheduleBatch
    from moonlang.srt.speculative.eagle_info import EagleVerifyOutput
...
def compute_temp_top_p_normalized_logprobs(
    ...
    if logits_metadata.top_p_normalized_logprobs and (top_p != 1.0).any():
        from moonlang.srt.layers.sampler import top_p_normalize_probs_torch
