...
from moonlang.srt.layers.rotary_embedding.base import RotaryEmbedding
from moonlang.srt.layers.rotary_embedding.triton_kernels import (
    triton_ernie45_rope_fused_inplace,
    triton_mrope_fused,
)
from moonlang.srt.layers.rotary_embedding.utils import apply_rotary_emb
from moonlang.srt.layers.rotary_embedding.yarn import (
    yarn_find_correction_range,
    yarn_get_mscale_simple,
    yarn_linear_ramp_mask,
)
from moonlang.srt.server_args import get_global_server_args
from moonlang.srt.utils import is_cuda, is_npu

_is_cuda = is_cuda()
_is_npu = is_npu()

if _is_cuda:
    from moonlang.jit_kernel.rope import apply_rope_with_cos_sin_cache_inplace
...
class MRotaryEmbedding(RotaryEmbedding):
    ...
    def get_rope_index(
        ...
        **kwargs,
        ...
        from moonlang.srt.layers.rotary_embedding.mrope_rope_index import get_rope_index
    ...
    def get_rope_index_qwen3_omni(
        ...
        **kwargs,
        ...
        from moonlang.srt.layers.rotary_embedding.mrope_rope_index import (
