...
if TYPE_CHECKING:
    from moonlang.jit_kernel.rope import FusedSetKVBufferArg  # For type check-only
...
class RotaryEmbedding(MultiPlatformOp):
    ...
    def __init__(
        ...
        if (
            ...
            # rotary_embedding from moonlang.jit_kernel.pos_enc and vllm._custom_ops has the same implementation.
            # TODO: Test on different devices and remove this conditional.
            if _is_cuda:
                from moonlang.jit_kernel.pos_enc import rotary_embedding
            elif _is_hip:
