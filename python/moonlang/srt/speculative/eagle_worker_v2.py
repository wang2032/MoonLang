...
from moonlang.srt.hardware_backend.npu.graph_runner.eagle_draft_extend_npu_graph_runner import (
    EAGLEDraftExtendNpuGraphRunner,
)
from moonlang.srt.hardware_backend.npu.graph_runner.eagle_draft_npu_graph_runner import (
    EAGLEDraftNpuGraphRunner,
)
from moonlang.srt.layers.attention.triton_backend import TritonMultiStepDraftBackend
from moonlang.srt.layers.attention.trtllm_mla_backend import (
    TRTLLMMLAMultiStepDraftBackend,
)
from moonlang.srt.layers.dp_attention import get_attention_tp_group
from moonlang.srt.layers.moe.utils import (
    speculative_moe_a2a_backend_context,
    speculative_moe_backend_context,
)
from moonlang.srt.managers.io_struct import UpdateWeightsFromTensorReqInput
from moonlang.srt.managers.schedule_batch import ModelWorkerBatch
from moonlang.srt.managers.scheduler import GenerationBatchResult
from moonlang.srt.managers.tp_worker import TpModelWorker
from moonlang.srt.model_executor.forward_batch_info import CaptureHiddenMode, ForwardBatch
from moonlang.srt.server_args import ServerArgs
from moonlang.srt.speculative.base_spec_worker import BaseDraftWorker, BaseSpecWorker
from moonlang.srt.speculative.draft_utils import DraftBackendFactory
from moonlang.srt.speculative.eagle_draft_cuda_graph_runner import (
    EAGLEDraftCudaGraphRunner,
)
from moonlang.srt.speculative.eagle_draft_extend_cuda_graph_runner import (
    EAGLEDraftExtendCudaGraphRunner,
)
from moonlang.srt.speculative.eagle_info import EagleDraftInput, EagleVerifyInput
from moonlang.srt.speculative.eagle_info_v2 import (
    assign_extend_cache_locs,
    fill_accepted_out_cache_loc,
    fill_new_verified_id,
)
from moonlang.srt.speculative.eagle_utils import TreeMaskMode, build_tree_kernel_efficient
from moonlang.srt.speculative.spec_info import SpeculativeAlgorithm
from moonlang.srt.speculative.spec_utils import (
    detect_nan,
    draft_tp_context,
...
from moonlang.srt.utils.patch_torch import monkey_patch_torch_reductions
