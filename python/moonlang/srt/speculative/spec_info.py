...
if TYPE_CHECKING:
    ...
    from moonlang.srt.speculative.base_spec_worker import BaseSpecWorker
    from moonlang.srt.speculative.ngram_worker import NGRAMWorker
...
class SpeculativeAlgorithm(Enum):
    ...
    def create_worker(
        ...
        if self.is_eagle() and server_args.enable_multi_layer_eagle:
            ...
            if enable_overlap:
                from moonlang.srt.speculative.multi_layer_eagle_worker_v2 import (
                    MultiLayerEagleWorkerV2,
                )

                return MultiLayerEagleWorkerV2

            from moonlang.srt.speculative.multi_layer_eagle_worker import (
            ...
            if enable_overlap:
                from moonlang.srt.speculative.eagle_worker_v2 import EAGLEWorkerV2
            ...
            if enable_overlap:
                from moonlang.srt.speculative.standalone_worker_v2 import (
                    StandaloneWorkerV2,
                )

                return StandaloneWorkerV2

            from moonlang.srt.speculative.standalone_worker import StandaloneWorker
