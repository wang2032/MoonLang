...
from moonlang.srt.layers.moe.utils import speculative_moe_backend_context
...
from moonlang.srt.speculative.eagle_info_v2 import fill_new_verified_id
from moonlang.srt.speculative.eagle_utils import TreeMaskMode, build_tree_kernel_efficient
from moonlang.srt.speculative.multi_layer_eagle_draft_extend_cuda_graph_runner import (
    MultiLayerEagleMultiStepDraftExtendCudaGraphRunner,
)
from moonlang.srt.speculative.multi_layer_eagle_utils import (
...
from moonlang.srt.utils.common import empty_context, fast_topk

if TYPE_CHECKING:
    from moonlang.srt.model_executor.model_runner import ModelRunner, ModelRunnerOutput
...
class MultiLayerEagleDraftWorker(BaseDraftWorker):
    ...
    def init_attention_backend(self):
        ...
        for step in range(self.speculative_num_steps):
            from moonlang.srt.layers.attention.flashattention_backend import (
