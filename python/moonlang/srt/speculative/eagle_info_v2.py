...
from moonlang.srt.managers.schedule_batch import ModelWorkerBatch, ScheduleBatch
from moonlang.srt.managers.utils import get_alloc_len_per_decode
...
from moonlang.srt.utils.common import is_cuda, is_hip, is_npu, next_power_of_2
...
class EagleDraftInputV2Mixin:
    def prepare_for_decode(self: EagleDraftInput, batch: ScheduleBatch):
        ...
        from moonlang.srt.speculative.spec_utils import assign_req_to_token_pool_func
