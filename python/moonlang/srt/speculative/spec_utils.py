...
from moonlang.srt.mem_cache.common import get_last_loc
from moonlang.srt.server_args import ServerArgs, get_global_server_args
from moonlang.srt.utils import is_cuda, is_hip, is_npu, next_power_of_2
...
if _is_cuda:
    ...
    from moonlang.srt.utils.common import fast_topk
