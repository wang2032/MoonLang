...
from moonlang.jit_kernel.benchmark.utils import (
    DEFAULT_DEVICE,
    DEFAULT_DTYPE,
    get_benchmark_range,
    run_benchmark,
...
def sglang_rope_v0(
    ...
    from moonlang.jit_kernel.pos_enc import rotary_embedding_with_key
...
def sglang_rope_v2(
    ...
    from moonlang.jit_kernel.rope import apply_rope_inplace
...
def rope_v0_store(
    ...
    from moonlang.jit_kernel.kvcache import store_cache
    from moonlang.jit_kernel.rope import apply_rope_inplace
...
def rope_v2_store(
    ...
    from moonlang.jit_kernel.rope import apply_rope_inplace_with_kvcache
