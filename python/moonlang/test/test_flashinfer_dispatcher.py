...
from moonlang.srt.distributed import init_distributed_environment
from moonlang.srt.distributed.parallel_state import (
    get_tp_group,
    initialize_model_parallel,
)
from moonlang.srt.layers.dp_attention import set_dp_buffer_len
from moonlang.srt.layers.moe.token_dispatcher.flashinfer import FlashinferDispatcher
from moonlang.srt.layers.moe.utils import initialize_moe_config
from moonlang.srt.server_args import ServerArgs, set_global_server_args_for_scheduler
...
class TestFlashinferDispatcher(CustomTestCase):
    ...
    def test_dispatch_basic(self):
        ...
        from moonlang.srt.layers.moe.topk import StandardTopKOutput
