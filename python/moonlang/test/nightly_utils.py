...
from moonlang.test.nightly_bench_utils import BenchmarkResult, generate_markdown_report
from moonlang.test.test_utils import (
...
class NightlyBenchmarkRunner:
    ...
    def build_benchmark_command(
        ...
        command = [
            "python3",
            "-m",
            "moonlang.bench_one_batch_server",
            "--model",
            model_path,
            "--base-url",
            self.base_url,
