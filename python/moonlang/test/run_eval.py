...
from moonlang.test.simple_eval_common import (
...
def run_eval(args):
    ...
    from moonlang.test.test_utils import dump_metric
    ...
    if args.eval_name == "mmlu":
        from moonlang.test.simple_eval_mmlu import MMLUEval
        ...
        from moonlang.test.simple_eval_math import MathEval
        ...
        from moonlang.test.simple_eval_mgsm import MGSMEval
        ...
        from moonlang.test.simple_eval_gpqa import GPQAEval
        ...
        from moonlang.test.simple_eval_humaneval import HumanEval

        eval_obj = HumanEval(args.num_examples, args.num_threads)
    elif args.eval_name == "longbench_v2":
        from moonlang.test.simple_eval_longbench_v2 import LongBenchV2Eval
        ...
        from moonlang.test.simple_eval_mmmu_vlm import MMMUVLMEval
        ...
        from moonlang.test.simple_eval_aime25 import AIME25Eval

        eval_obj = AIME25Eval(args.num_examples, args.num_threads)
    elif args.eval_name == "gsm8k":
        from moonlang.test.simple_eval_gsm8k import GSM8KEval
