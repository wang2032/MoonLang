...
if TYPE_CHECKING:
    from moonlang.multimodal_gen.runtime.server_args import Backend

from moonlang.multimodal_gen.configs.pipeline_configs import (
    FastHunyuanConfig,
    FluxPipelineConfig,
    HunyuanConfig,
    WanI2V480PConfig,
...
from moonlang.multimodal_gen.configs.pipeline_configs.base import PipelineConfig
from moonlang.multimodal_gen.configs.pipeline_configs.flux import (
    Flux2KleinPipelineConfig,
    Flux2PipelineConfig,
)
from moonlang.multimodal_gen.configs.pipeline_configs.glm_image import (
    GlmImagePipelineConfig,
)
from moonlang.multimodal_gen.configs.pipeline_configs.ltx_2 import LTX2PipelineConfig
from moonlang.multimodal_gen.configs.pipeline_configs.mova import (
    MOVA360PConfig,
    MOVA720PConfig,
)
from moonlang.multimodal_gen.configs.pipeline_configs.qwen_image import (
...
from moonlang.multimodal_gen.configs.pipeline_configs.wan import (
...
from moonlang.multimodal_gen.configs.sample.flux import (
    Flux2KleinSamplingParams,
    FluxSamplingParams,
)
from moonlang.multimodal_gen.configs.sample.glmimage import GlmImageSamplingParams
from moonlang.multimodal_gen.configs.sample.hunyuan import (
    FastHunyuanSamplingParam,
    HunyuanSamplingParams,
)
from moonlang.multimodal_gen.configs.sample.ltx_2 import LTX2SamplingParams
from moonlang.multimodal_gen.configs.sample.mova import (
    MOVA_360P_SamplingParams,
    MOVA_720P_SamplingParams,
)
from moonlang.multimodal_gen.configs.sample.qwenimage import (
    QwenImage2512SamplingParams,
    QwenImageEditPlusSamplingParams,
    QwenImageLayeredSamplingParams,
    QwenImageSamplingParams,
)
from moonlang.multimodal_gen.configs.sample.wan import (
...
from moonlang.multimodal_gen.configs.sample.zimage import (
    ZImageSamplingParams,
    ZImageTurboSamplingParams,
)
from moonlang.multimodal_gen.runtime.pipelines_core.composed_pipeline_base import (
    ComposedPipelineBase,
)
from moonlang.multimodal_gen.runtime.utils.hf_diffusers_utils import (
...
def _discover_and_register_pipelines():
    ...
    This function scans the 'moonlang.multimodal_gen.runtime.pipelines' package,
    ...
    package_name = "moonlang.multimodal_gen.runtime.pipelines"
...
def _get_diffusers_model_info(model_path: str) -> ModelInfo:
    ...
    """
    from moonlang.multimodal_gen.configs.pipeline_configs.diffusers_generic import (
        DiffusersGenericPipelineConfig,
    )
    from moonlang.multimodal_gen.configs.sample.diffusers_generic import (
        DiffusersGenericSamplingParams,
    )
    from moonlang.multimodal_gen.runtime.pipelines.diffusers_pipeline import (
        DiffusersPipeline,
    )
