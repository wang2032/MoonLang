...
from moonlang.multimodal_gen.runtime.platforms.interface import (  # noqa: F401
    AttentionBackendEnum,
    Platform,
    PlatformEnum,
)
from moonlang.multimodal_gen.runtime.utils.logging_utils import init_logger
from moonlang.multimodal_gen.utils import resolve_obj_by_qualname
...
def cuda_platform_plugin() -> str | None:
    ...
    return (
        "moonlang.multimodal_gen.runtime.platforms.cuda.CudaPlatform" if is_cuda else None
    )
...
def mps_platform_plugin() -> str | None:
    ...
    return "moonlang.multimodal_gen.runtime.platforms.mps.MpsPlatform" if is_mps else None


def cpu_platform_plugin() -> str | None:
    """Detect if CPU platform should be used."""
    # CPU is always available as a fallback
    return "moonlang.multimodal_gen.runtime.platforms.cpu.CpuPlatform"
...
def rocm_platform_plugin() -> str | None:
    ...
    return (
        "moonlang.multimodal_gen.runtime.platforms.rocm.RocmPlatform" if is_rocm else None
    )
...
def npu_platform_plugin() -> str | None:
    ...
    return (
        "moonlang.multimodal_gen.runtime.platforms.npu.NPUPlatformBase"
        if is_npu
        else None
    )
...
def musa_platform_plugin() -> str | None:
    ...
    return (
        "moonlang.multimodal_gen.runtime.platforms.musa.MusaPlatform" if is_musa else None
    )
...
def __getattr__(name: str):
    if name == "current_platform":
        ...
        # 1. out-of-tree platform plugins need `from moonlang.multimodal_gen.runtime.platforms import
