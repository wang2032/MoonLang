...
from moonlang.multimodal_gen import envs
from moonlang.multimodal_gen.runtime.platforms.interface import (
...
from moonlang.multimodal_gen.utils import import_pynvml
    ...
    def get_attn_backend_cls_str(
        ...
        if selected_backend == AttentionBackendEnum.SLIDING_TILE_ATTN:
            try:
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.sliding_tile_attn import (  # noqa: F401
                    SlidingTileAttentionBackend,
                )

                logger.info("Using Sliding Tile Attention backend")

                return "moonlang.multimodal_gen.runtime.layers.attention.backends.sliding_tile_attn.SlidingTileAttentionBackend"
            ...
            try:
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.sage_attn import (  # noqa: F401
                    SageAttentionBackend,
                )

                logger.info("Using Sage Attention backend")

                return "moonlang.multimodal_gen.runtime.layers.attention.backends.sage_attn.SageAttentionBackend"
            except ImportError as e:
                logger.info(e)
                logger.info(
            ...
            try:
                from moonlang.multimodal_gen.runtime.layers.attention.backends.sage_attn3 import (  # noqa: F401
                    SageAttention3Backend,
                )

                logger.info("Using Sage Attention 3 backend")
                return "moonlang.multimodal_gen.runtime.layers.attention.backends.sage_attn3.SageAttention3Backend"
            except ImportError as e:
                logger.info(e)
                logger.info(
            ...
            try:
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.video_sparse_attn import (  # noqa: F401
                    VideoSparseAttentionBackend,
                )

                logger.info("Using Video Sparse Attention backend")

                return "moonlang.multimodal_gen.runtime.layers.attention.backends.video_sparse_attn.VideoSparseAttentionBackend"
            except ImportError as e:
                logger.error(
            ...
            try:
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.sparse_video_gen_2_attn import (  # noqa: F401
                    SparseVideoGen2AttentionBackend,
                )

                logger.info("Using Sparse Video Gen 2 (SAP) Attention backend")
                return "moonlang.multimodal_gen.runtime.layers.attention.backends.sparse_video_gen_2_attn.SparseVideoGen2AttentionBackend"
            except ImportError as e:
                logger.error(
            ...
            try:
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.vmoba import (  # noqa: F401
                    VMOBAAttentionBackend,
                )

                logger.info("Using Video MOBA Attention backend")

                return "moonlang.multimodal_gen.runtime.layers.attention.backends.vmoba.VMOBAAttentionBackend"
            except ImportError as e:
                logger.error(
            ...
            return "moonlang.multimodal_gen.runtime.layers.attention.backends.aiter.AITerBackend"
        elif selected_backend == AttentionBackendEnum.TORCH_SDPA:
            logger.info("Using Torch SDPA backend")
            return "moonlang.multimodal_gen.runtime.layers.attention.backends.sdpa.SDPABackend"
        elif selected_backend == AttentionBackendEnum.SLA_ATTN:
            logger.info("Using Sparse Linear Attention backend")
            return "moonlang.multimodal_gen.runtime.layers.attention.backends.sparse_linear_attn.SparseLinearAttentionBackend"
        elif selected_backend == AttentionBackendEnum.SAGE_SLA_ATTN:
            logger.info("Using Sage Sparse Linear Attention backend")
            return "moonlang.multimodal_gen.runtime.layers.attention.backends.sparse_linear_attn.SageSparseLinearAttentionBackend"
        elif selected_backend == AttentionBackendEnum.FA2:
            from moonlang.multimodal_gen.runtime.layers.attention.backends.flash_attn_2 import (  # noqa: F401
                FlashAttention2Backend,
            )

            logger.info("Using FlashAttention2 backend")
            return "moonlang.multimodal_gen.runtime.layers.attention.backends.flash_attn_2.FlashAttention2Backend"
            ...
            if cls.is_sm120():
                ...
                from moonlang.multimodal_gen.runtime.layers.attention.backends.flash_attn import (
                    set_fa_ver,
                )
        ...
        if target_backend == AttentionBackendEnum.FA:
            try:
                from moonlang.multimodal_gen.runtime.layers.attention.backends.flash_attn import (  # noqa: F401
        ...
        return "moonlang.multimodal_gen.runtime.layers.attention.backends.flash_attn.FlashAttentionBackend"

    @classmethod
    def get_device_communicator_cls(cls) -> str:
        return "moonlang.multimodal_gen.runtime.distributed.device_communicators.cuda_communicator.CudaCommunicator"  # noqa
