...
from moonlang.multimodal_gen.runtime.platforms.interface import DeviceCapability
...
class MpsPlatform(Platform):
    ...
    def get_attn_backend_cls_str(
        ...
        return (
            "moonlang.multimodal_gen.runtime.layers.attention.backends.sdpa.SDPABackend"
        )

    @classmethod
    def get_device_communicator_cls(cls) -> str:
        # Use base communicator for MPS
        return "moonlang.multimodal_gen.runtime.distributed.device_communicators.base_device_communicator.DeviceCommunicatorBase"
