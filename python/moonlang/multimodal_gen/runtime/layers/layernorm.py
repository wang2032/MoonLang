...
from moonlang.jit_kernel.diffusion.triton.norm import norm_infer, rms_norm_fn
from moonlang.jit_kernel.diffusion.triton.rmsnorm_onepass import triton_one_pass_rms_norm
from moonlang.jit_kernel.diffusion.triton.scale_shift import fuse_scale_shift_kernel
from moonlang.jit_kernel.norm import can_use_fused_inplace_qknorm, fused_inplace_qknorm
from moonlang.multimodal_gen.runtime.distributed.parallel_state import (
    get_tensor_model_parallel_rank,
    get_tensor_model_parallel_world_size,
    get_tp_group,
)
from moonlang.multimodal_gen.runtime.layers.custom_op import CustomOp
from moonlang.multimodal_gen.runtime.utils.common import get_bool_env_var
...
class _ScaleResidualNormScaleShift(CustomOp):
    ...
    def forward_cuda(
        ...
        from moonlang.jit_kernel.diffusion.cutedsl.scale_residual_norm_scale_shift import (
