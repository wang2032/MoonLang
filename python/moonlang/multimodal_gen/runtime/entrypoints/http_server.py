...
from moonlang.multimodal_gen.configs.sample.sampling_params import SamplingParams
from moonlang.multimodal_gen.runtime.entrypoints.openai import image_api, video_api
from moonlang.multimodal_gen.runtime.entrypoints.openai.protocol import (
    VertexGenerateReqInput,
)
from moonlang.multimodal_gen.runtime.entrypoints.openai.utils import build_sampling_params
from moonlang.multimodal_gen.runtime.entrypoints.post_training import weights_api
from moonlang.multimodal_gen.runtime.entrypoints.utils import (
    prepare_request,
    save_outputs,
)
from moonlang.multimodal_gen.runtime.scheduler_client import async_scheduler_client
...
async def lifespan(app: FastAPI):
    from moonlang.multimodal_gen.runtime.scheduler_client import (
...
async def get_models(request: Request):
    ...
    """
    from moonlang.multimodal_gen.registry import get_model_info
...
def create_app(server_args: ServerArgs):
    ...
    from moonlang.multimodal_gen.runtime.entrypoints.openai import common_api
