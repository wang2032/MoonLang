...
from moonlang.multimodal_gen.configs.pipeline_configs.base import ModelTaskType, STA_Mode
from moonlang.multimodal_gen.configs.pipeline_configs.wan import (
    Wan2_2_TI2V_5B_Config,
    WanI2V480PConfig,
)
from moonlang.multimodal_gen.runtime.cache.cache_dit_integration import (
    CacheDitConfig,
...
from moonlang.multimodal_gen.runtime.distributed import (
...
from moonlang.multimodal_gen.runtime.distributed.communication_op import (
    sequence_model_parallel_all_gather,
)
from moonlang.multimodal_gen.runtime.distributed.parallel_state import (
    get_cfg_group,
    get_classifier_free_guidance_rank,
)
from moonlang.multimodal_gen.runtime.layers.attention.selector import get_attn_backend
from moonlang.multimodal_gen.runtime.layers.attention.STA_configuration import (
    configure_sta,
    save_mask_search_results,
)
from moonlang.multimodal_gen.runtime.loader.component_loaders.transformer_loader import (
    TransformerLoader,
)
from moonlang.multimodal_gen.runtime.managers.forward_context import set_forward_context
from moonlang.multimodal_gen.runtime.pipelines_core.schedule_batch import Req
from moonlang.multimodal_gen.runtime.pipelines_core.stages.base import (
    PipelineStage,
    StageParallelismType,
)
from moonlang.multimodal_gen.runtime.pipelines_core.stages.validators import (
    StageValidators as V,
)
from moonlang.multimodal_gen.runtime.pipelines_core.stages.validators import (
    VerificationResult,
)
from moonlang.multimodal_gen.runtime.platforms import (
    AttentionBackendEnum,
    current_platform,
)
from moonlang.multimodal_gen.runtime.server_args import ServerArgs
from moonlang.multimodal_gen.runtime.utils.layerwise_offload import OffloadableDiTMixin
from moonlang.multimodal_gen.runtime.utils.logging_utils import init_logger
from moonlang.multimodal_gen.runtime.utils.perf_logger import StageProfiler
from moonlang.multimodal_gen.runtime.utils.profiler import SGLDiffusionProfiler
from moonlang.multimodal_gen.utils import dict_to_3d_list, masks_like
...
class DenoisingStage(PipelineStage):
    ...
    def _build_attn_metadata(
        ...
        *,
        ...
        if (
            ...
            if cache is None:
                from moonlang.multimodal_gen.runtime.layers.attention.backends.sparse_video_gen_2_attn import (
                    Svg2Cache,
                )
    ...
    def prepare_sta_param(self, batch: Req, server_args: ServerArgs):
        ...
        if STA_mode == STA_Mode.STA_SEARCHING:
            ...
            import moonlang.multimodal_gen.envs as envs
