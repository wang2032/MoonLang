...
from moonlang.multimodal_gen.configs.models.dits.qwenimage import QwenImageDitConfig
from moonlang.multimodal_gen.runtime.distributed import get_local_torch_device
from moonlang.multimodal_gen.runtime.loader.fsdp_load import (
    load_model_from_full_model_state_dict,
    shard_model,
)
from moonlang.multimodal_gen.runtime.loader.utils import (
    get_param_names_mapping,
    set_default_torch_dtype,
)
from moonlang.multimodal_gen.runtime.loader.weight_utils import (
    safetensors_weights_iterator,
)
from moonlang.multimodal_gen.runtime.models.registry import ModelRegistry
from moonlang.multimodal_gen.runtime.models.schedulers.scheduling_comfyui_passthrough import (
    ComfyUIPassThroughScheduler,
)
from moonlang.multimodal_gen.runtime.pipelines_core import LoRAPipeline
from moonlang.multimodal_gen.runtime.pipelines_core.composed_pipeline_base import (
    ComposedPipelineBase,
)
from moonlang.multimodal_gen.runtime.pipelines_core.stages import (
...
from moonlang.multimodal_gen.utils import PRECISION_TO_TYPE, set_mixed_precision_policy
...
class ComfyUIQwenImagePipelineBase(LoRAPipeline, ComposedPipelineBase):
    ...
    def _prepare_dit_config_and_mapping(self, server_args: ServerArgs):
        from moonlang.multimodal_gen.configs.models.dits.qwenimage import (
            QwenImageArchConfig,
        )
    ...
    def _instantiate_model(
        ...
        from moonlang.multimodal_gen.runtime.platforms import current_platform
...
class ComfyUIQwenImagePipeline(ComfyUIQwenImagePipelineBase):
    ...
    from moonlang.multimodal_gen.configs.sample.qwenimage import QwenImageSamplingParams
