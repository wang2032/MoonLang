...
from moonlang.multimodal_gen.configs.models.dits.zimage import ZImageDitConfig
...
class ComfyUIZImagePipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    from moonlang.multimodal_gen.configs.pipeline_configs.zimage import (
        ZImagePipelineConfig,
    )
    from moonlang.multimodal_gen.configs.sample.zimage import ZImageSamplingParams
