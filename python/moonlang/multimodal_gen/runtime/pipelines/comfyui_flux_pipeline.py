...
from moonlang.multimodal_gen.configs.models.dits.flux import FluxConfig
...
class ComfyUIFluxPipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    from moonlang.multimodal_gen.configs.pipeline_configs.flux import FluxPipelineConfig
    from moonlang.multimodal_gen.configs.sample.flux import FluxSamplingParams
