...
from moonlang.multimodal_gen.runtime.utils.hf_diffusers_utils import get_hf_config
...
class ComponentLoader(ABC):
    ...
    def _ensure_loaders_registered(cls):
        ...
        package_name = (
            __package__
            or "moonlang.multimodal_gen.runtime.loader.component_loaders.component_loaders"
        )
