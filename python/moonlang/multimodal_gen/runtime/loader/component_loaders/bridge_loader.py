...
from moonlang.multimodal_gen.runtime.loader.utils import _list_safetensors_files
...
class BridgeLoader(ComponentLoader):
    ...
    def load_customized(
        ...
        if bridge_config is not None:
            ...
            from moonlang.multimodal_gen.configs.models.bridges.mova_dual_tower import (
                MOVADualTowerConfig,
            )
