...
from moonlang.multimodal_gen.runtime.utils.perf_logger import get_git_commit_hash
...
try:
    import moonlang.multimodal_gen.test.server.testcase_configs as configs
