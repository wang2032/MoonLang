...
import moonlang.multimodal_gen.runtime.entrypoints.openai.storage as storage_mod
from moonlang.multimodal_gen.runtime.entrypoints.openai.storage import CloudStorage
